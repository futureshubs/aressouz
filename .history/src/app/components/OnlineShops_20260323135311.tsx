...
export default function OnlineShops({ onAddToCart, initialTab = 'shops' }: { onAddToCart?: (product: any, quantity: number, variantId?: string, variantName?: string) => void; initialTab?: 'products' | 'shops' }) {
  ...
  const loadAllProducts = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('✅ All products set:', data.products?.length || 0, 'ta');
      } else {
