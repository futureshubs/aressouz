...
export function Cart({ items, isOpen, onClose, onUpdateQuantity, onRemoveItem, onClearCart }: CartProps) {
  // Get rental cart
  const { cartItems: rentalItems, removeFromCart: removeRentalItem, updateQuantity: updateRentalQuantity, getTotalPrice: getRentalTotal } = useRentalCart();
        ...
        {items.length > 0 && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs" style={{ color: textSecondary }}>Mahsulotlar:</p>
                </div>
                <p className="text-base font-bold" style={{ color: textPrimary }}>{items.length} ta</p>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs" style={{ color: textSecondary }}>Jami dona:</p>
                </div>
                <p className="text-base font-bold" style={{ color: textPrimary }}>
                  {items.reduce((sum, item) => sum + item.quantity, 0)} dona
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-bold" style={{ color: accentColor.color }}>
                    {Math.round(total / 12).toLocaleString('uz-UZ')}
                  </p>
            ...
            <button
              ...
              className="w-full py-5 rounded-2xl text-white transition-all active:scale-95 font-bold text-lg shadow-2xl"
              style={{ 
                background: accentColor.gradient,
      ...
      {showCheckout && (
        <Checkout
          ...
          onClose={() => {
            ...
            onClose(); // Close cart too after checkout
          }}
          orderType="market"
