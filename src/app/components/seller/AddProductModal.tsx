...
export default function AddProductModal({ isOpen, onClose, onSuccess, token }: AddProductModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const errorMessage = error?.message || 'Mahsulot qo\'shishda xatolik. Iltimos, qayta urinib ko\'ring.';
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    placeholder="Masalan: 6.2 dyuymli ekran"
                  />
                  <button
                    onClick={() => {
                      if (newFeature.trim()) {
                    ...
                    className="px-4 py-3 rounded-xl font-medium transition-all active:scale-95 whitespace-nowrap"
