...
import { Package, Save, ScanLine, Trash2, X } from 'lucide-react';
      ...
      >
        ...
        <div className={`${dillerSheetScrollClass} px-4 py-4 space-y-3 max-w-lg mx-auto w-full pb-6`}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="block text-xs font-medium opacity-80 mb-1">Olish narxi</label>
              <input
                type="number"
                min={0}
                value={buyPrice}
        ...
        <div
          className="shrink-0 px-4 py-3 app-safe-pad max-w-lg mx-auto w-full"
          style={iosGlassBarStyle(isDark)}
        >
          <button
            type="button"
          ...
          <button
            ...
            className="w-full mt-2 py-2.5 rounded-xl font-semibold text-sm text-red-400 flex items-center justify-center gap-1.5 active:opacity-70"
          >
